...
ActiveRecord::Schema.define(version: 20220119193715) do
  ...
  create_table "death_records", force: :cascade do |t|
    ...
    t.string   "message_id"
    t.boolean  "voided"
    t.boolean  "initially_submitted",        default: false, null: false
    ...
    t.boolean  "currently_submitted",        default: false, null: false
