module Pages
  class EditMedical < Edit
    ...
    def check_human_readable(feature, view=false)
      ...
      feature.expect(self).to feature.have_content 'Rupture of myocardium: Minutes'
      feature.expect(self).to feature.have_content 'Acute myocardial infarction: 6 days'
      feature.expect(self).to feature.have_content 'Coronary artery thrombosis: 5 years'
      feature.expect(self).to feature.have_content 'Atherosclerotic coronary artery disease: 7 years'
    ...
    def fill_out(feature)
      ...
      within('fieldset#codfield') do
        fill_in 'immediate', with: 'Rupture of myocardium'
        fill_in 'immediateInt', with: 'Minutes'
        fill_in 'under1', with: 'Acute myocardial infarction'
        fill_in 'under1Int', with: '6 days'
        fill_in 'under2', with: 'Coronary artery thrombosis'
        fill_in 'under2Int', with: '5 years'
        fill_in 'under3', with: 'Atherosclerotic coronary artery disease'
        fill_in 'under3Int', with: '7 years'
      end
